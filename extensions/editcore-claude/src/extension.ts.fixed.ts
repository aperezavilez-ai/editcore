...
import { registerEditcoreConnectCommands } from "./agent/editcoreConnect";
import { registerGlobalCommands } from "./global/globalCommands";
import {
  migrateLegacyApiKeysFile,
  resetLegacyApiKeysMigrationFlag,
} from "./platform/legacyApiKeysMigration";
...
export async function activate(context: vscode.ExtensionContext) {
  ...
  registerEditcoreConnectCommands(context);
