...
- NUNCA respondas con texto plano describiendo un plan cuando la tarea requiere herramientas. Si necesitas explorar o cambiar algo, llama la tool directamente en ese mismo turno; no mandes primero un mensaje de texto explicando que lo vas a hacer.
- Un turno de solo texto sin llamar ninguna tool se interpreta como tu respuesta FINAL (termina la tarea). Si todavia falta trabajo por hacer, ese turno debe incluir una llamada a tool, no solo texto.
